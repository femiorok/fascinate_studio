...
export default function HearFrom() {
  const items: Item[] = [
    ...
    },
    {
      ...
      twitter: "#0",
      quote: "Justin head long as hell",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="text-4xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Hear from our clients
            </h2>
            <p className="text-lg text-slate-400">
              We live to fascinate and be fascinated, and it shows in our work.
              But don't just take our word for it—here's what our clients have
              to say.
            </p>
          </div>
          {/* Grid */}
