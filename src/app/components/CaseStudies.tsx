  ...
  return (
    <div>
      ...
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        We worked with Brand to accelerate their initiative to spread environmental awareness to HBCU students. <span className="underline">Read More</span>
      </p>
    </div>
  );
};
...
const SkeletonTwo = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        Brand X needed a crew for their latest campaign, but it {`wasn't`} just any shoot. They needed engaging content that would outperform their last projects, and we delivered. <span className="underline">Read More</span>
      </p>
    </div>
  );
};
const SkeletonThree = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        Brand Y needed a crew for their latest campaign, but it {`wasn't`} just any shoot. They needed engaging content that would outperform their last projects, and we delivered. <span className="underline">Read More</span>
      </p>
    </div>
  );
};
const SkeletonFour = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        Brand Z needed a crew for their latest campaign, but it {`wasn't`} just any shoot. They needed engaging content that would outperform their last projects, and we delivered. <span className="underline">Read More</span>
      </p>
    </div>
  );
};
