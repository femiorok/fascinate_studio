...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      <div className="absolute opacity-10 inset-0 h-full w-full bg-black bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:24px_24px]"></div>
